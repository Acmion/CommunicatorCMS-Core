...
namespace CommunicatorCms.Core.Settings
{
    public static class UrlSettings
    {
        ...
        public static string StaticRootUrl { get; } = "/static";
        ...
        public static HashSet<string> RootUrlsWithNonVirtualPaths = new HashSet<string>() { CmsRootUrl, StaticRootUrl, ThemesRootUrl, GeneralRootUrl, ActionsRootUrl, ExtensionsRootUrl, RenderingRootUrl };
    }
}
